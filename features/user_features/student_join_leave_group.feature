Feature: Join group
  ...
  Background: 
    ...
    | 2        | 7, 8, 9 | 3:00pm  | 204 Dwinelle | Japanese | Thursday |
    And the following students exist:
    | id | first_name | last_name | sid  | gender | email | fluent_languages | first_lang_preference | facilitator | 
    | 1  | exisiting  | user      | 12345678 | female | user1@berkeley.edu | [english, spanish] | Japanese | false |
    | 2  | exisiting  | user      | 12345679 | female | user2@berkeley.edu | [english, japanese] | English | false |
